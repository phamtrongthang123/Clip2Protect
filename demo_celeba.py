...
input_dir = '/home/ptthang/UARK CLASS/privacy_face_protect/CelebA_HQ_face_gender_dataset_test_1000'
saved_dir = '/home/ptthang/UARK CLASS/privacy_face_protect/CelebA_HQ_face_gender_dataset_test_1000_new'
...
for image_path in tqdm(all_images):
    try:
        saved_dir_i = os.path.join(saved_dir, image_path.split('/')[-2])  
        os.makedirs(saved_dir_i, exist_ok=True)
        # get gender
        ...
        os.system(f'python main.py --data_dir auto_input_images --latent_path auto_ouput_images/latents.pt --protected_face_dir "{saved_dir_i}" --makeup_prompt "{current_prompt}"')
    except:
